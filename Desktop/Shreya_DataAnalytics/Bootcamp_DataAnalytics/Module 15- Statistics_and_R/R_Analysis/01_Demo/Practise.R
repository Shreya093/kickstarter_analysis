...
# Change demo_table3 to long dataset
...
# Check our both tables: demo_table3 and wide_table are equal
...
#create summary table
# compare the differences in average highway fuel economy (hwy) 
...
#scatter plot to visualize the relationship between the size of each car engine (displ) 
#versus their city fuel efficiency (cty)
...
#if we want to test if the miles driven from our previous sample dataset is statistically 
...
#determine if there is a statistical difference in overall highway fuel efficiency between 
#vehicles manufactured in 1999 versus 2008. In other words, we are testing our null hypothesis—that 
#the overall difference is zero. 
